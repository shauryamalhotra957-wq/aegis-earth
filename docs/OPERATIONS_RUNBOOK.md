# aegis-earth: Production Operations Runbook & Incident Triage

Operational standards, telemetry thresholds, and disaster recovery procedures for **Explainable Disaster-Resilience Command Center & Allocation Engine**.
